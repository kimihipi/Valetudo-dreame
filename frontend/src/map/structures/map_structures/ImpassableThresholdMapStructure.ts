...
class ImpassableThresholdMapStructure extends MapStructure {
    public static readonly TYPE = "ImpassableThresholdMapStructure";
...
export default ImpassableThresholdMapStructure;
