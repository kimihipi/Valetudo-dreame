...
class PassableThresholdClientStructure extends LineClientStructure {
    public static readonly TYPE = "PassableThresholdClientStructure";
...
export default PassableThresholdClientStructure;
